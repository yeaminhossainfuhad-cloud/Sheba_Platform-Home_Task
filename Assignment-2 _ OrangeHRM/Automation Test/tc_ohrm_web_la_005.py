#Leave application with invalid date range
...
def test_apply_leave_complete_flow():
    ...
    try:
        ...
        # Step 3: Apply Leave
        # Select leave type
        leave_type_dropdown = wait.until(EC.element_to_be_clickable((By.XPATH,
                                                                     "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[1]/div/div[2]/div/div/div[2]/i")))
        leave_type_dropdown.click()

        # Select leave type
        option = wait.until(EC.element_to_be_clickable((By.XPATH,
                                                        "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[1]/div/div[1]/div/div[2]/div/div[2]/div[2]")))
        option.click()



        from_date_field = driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/div/div/i")
        from_date_field.click()
        set_from_date_field= driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div[3]/div[13]/div")
        set_from_date_field.click()

        to_date_field = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/div/div/i")
        to_date_field.click()
        set_to_date_field = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/div/div[2]/div/div[3]/div[11]/div")
        set_to_date_field.click()

        # Verify Show "To date should be after from date"
        success_element = wait.until(EC.presence_of_element_located(
            (By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/span")))
