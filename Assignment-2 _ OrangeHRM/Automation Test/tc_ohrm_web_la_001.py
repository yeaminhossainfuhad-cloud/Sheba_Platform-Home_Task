...
def test_apply_leave_complete_flow():
    ...
    try:
        ...
        set_from_date_field= driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div[3]/div[19]/div")
        ...
        to_date_field.click()
        set_to_date_field = driver.find_element(By.XPATH,"/html/body/div/div[1]/div[2]/div[2]/div/div/form/div[2]/div/div[2]/div/div[2]/div/div[2]/div/div[3]/div[20]/div")
        ...
        success_element = wait.until(EC.presence_of_element_located(
            (By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/h6")))

        assert success_element.is_displayed()
        print("Test passed: Leave applied successfully!")
